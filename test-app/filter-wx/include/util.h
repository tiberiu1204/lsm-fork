...
#define ERROR(msg...)                                              \
    do {                                                           \
        fprintf(stdout, RED_B "[!] %s:%-4d ", __FILE__, __LINE__); \
...
#define WAR(msg...)                                                   \
    do {                                                              \
        fprintf(stdout, YELLOW_B "[?] %s:%-4d ", __FILE__, __LINE__); \
        fprintf(stdout, UNSET_B msg);                                 \
        fprintf(stdout, CLR "\n");                                    \
    } while (0)
...
#define DEBUG(msg...)                                                   \
    do {                                                                \
        if (DEBUG_EN) {                                                 \
            fprintf(stdout, BLUE_B "[-] %s:%-4d ", __FILE__, __LINE__); \
            fprintf(stdout, UNSET_B msg);                               \
            fprintf(stdout, CLR "\n");                                  \
        }                                                               \
    } while (0)
...
#define INFO(msg...)                                                 \
    do {                                                             \
        fprintf(stdout, GREEN_B "[*] %s:%-4d ", __FILE__, __LINE__); \
        fprintf(stdout, UNSET_B msg);                                \
        fprintf(stdout, CLR "\n");                                   \
    } while (0)
